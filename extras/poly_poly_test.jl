...
P1 = DCD.Polygon(create_n_sided(5,0.8)...,0.4)
P2 = DCD.Polygon(create_n_sided(8,0.4)...,0.23)

P1.r = 0.5*(@SVector randn(3))
...
prob.constraints += norm(x - (P1.r + Q̃1*y1)) <= α*P1.R
prob.constraints += P1.A*y1 <= α*P1.b
prob.constraints += norm(x - (P2.r + Q̃2*y2)) <= α*P2.R
prob.constraints += P2.A*y2 <= α*P2.b
