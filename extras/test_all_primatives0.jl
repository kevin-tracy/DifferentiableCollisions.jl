...
P1v = [
        ...
        DCD.Capsule(0.5,1.2),
        DCD.Cylinder(0.5,1.2),
        DCD.Cone(2.0,deg2rad(22)),
        DCD.Sphere(0.8),
        DCD.Polygon(create_n_sided(5,0.6)...,0.2)
        ]

P2v = [
        DCD.Polytope(SMatrix{14,3}(A1),SVector{14}(b1)),
        DCD.Capsule(0.7,1.4),
        DCD.Cylinder(0.4,1.2),
        DCD.Cone(2.2,deg2rad(18)),
        DCD.Sphere(0.63),
        DCD.Polygon(create_n_sided(8,0.7)...,0.16)
        ]
...
for P1 in P1v
    for P2 in P2v
        ...
        α,x,J = DCD.proximity_jacobian(P1,P2; verbose = true, pdip_tol = 1e-6)
